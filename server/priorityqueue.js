 ...
 * according to a comparison function comparFn.  The default compareFn
 * compares priority values using <, ===, and >; a custom comparision
 * function, using the same protocol as Array.prototype.sort, may be
